    ...
    form.addEventListener('submit', e => {
      ...
      fetch(scriptURL, { method: 'POST', body: new FormData(form)})
        .then(response => {
            msg.innerHTML = "Thank you For Subscribing by 19079"
            setTimeout(function(){
                msg.innerHTML = "We specialise in web development"
            }, 5000)
            form.reset()
        })
    ...
    form2.addEventListener('submit', e => {
      ...
      fetch(scriptURL2, { method: 'POST', body: new FormData(form2)})
        .then(response => {
            msg2.innerHTML = "Thanks for your contact details by sofia 19079"
            setTimeout(function(){
